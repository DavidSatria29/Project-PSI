        ...
        <div class="col-md-3">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row mt-3">
                @if ($product_order->status == 'Menunggu Pembayaran')
                  <a href="{{ route('customer.payment.orders', ['id'=>$product_order->id])}}" class="btn btn-primary">Bayar</a>
                @elseif ($product_order->status == 'Menunggu Konfirmasi Pembayaran')
                  <a href="{{ route('customer.confirmation.orders', ['id'=>$product_order->id])}}" class="btn btn-primary mt-2">Konfirmasi Pembayaran</a>
                  <a href="{{ route('customer.cancel.orders',['id'=>$product_order->id]) }}" class="btn btn-primary mt-3">Batalkan Pemesanan</a>
                @else
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row mx-auto">
                @if ($custom_order->status == 'Menunggu Pembayaran')
                  <a href="{{ route('customer.payment.orders', ['id'=>$custom_order->id])}}" class="btn btn-primary">Bayar</a>
                @elseif ($custom_order->status == 'Menunggu Konfirmasi')
                  <a href="{{ route('customer.confirmation.orders', ['id'=>$custom_order->id])}}" class="btn btn-primary">Konfirmasi Pembayaran</a>
                  <a href="{{ route('customer.cancel.orders',['id'=>$custom_order->id]) }}" class="btn btn-primary">Batalkan Pemesanan</a>
                @else
